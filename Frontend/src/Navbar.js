...
const handleLogout =(e)=>{
  ...
  return <AppBar position="static">
    <Toolbar>
      ...
      <Button style={{margin:0}} color="inherit" onClick={() => navigate("/dresses/add")}>
      ADD
      </Button>
      <Button color="inherit" onClick={() => navigate("/suggestion")}>
      suggestion
      </Button>
      {user && (<><Button color="inherit" aria-label="Like" onClick={()=>navigate("/whislist")}
 >
